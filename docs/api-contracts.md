...
Returns the list of predefined moods available for journal entries.
...
- Moods are predefined by the application.
- Users do not create moods directly.
- The frontend uses this endpoint to display mood selection options.
- Entry create/update requests send moodIds, not mood names.
````
